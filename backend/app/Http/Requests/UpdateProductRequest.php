...
class UpdateProductRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'slug' => ['required', 'string', 'max:500', Rule::unique('products', 'slug')->ignore($this->route('product')?->id)],
    ...
    protected function prepareForValidation(): void
    {
        ...
        while ($slug && Product::where('slug', $slug)->when($productId, function ($query) use ($productId) {
